...
[HtmlTargetElement("sanwo-custom-amount")]
public class SanwoCustomAmountTagHelper : TagHelper
{
    private readonly SanwoOptions _options;

    public SanwoCustomAmountTagHelper(IOptions<SanwoOptions> options)
    {
    ...
    public string Placeholder { get; set; } = "Enter amount";
    ...
    [HtmlAttributeName("min-amount")]
    public int? MinAmount { get; set; }

    [HtmlAttributeName("max-amount")]
    ...
    public override void Process(TagHelperContext context, TagHelperOutput output)
    {
        ...
        output.Attributes.SetAttribute("data-sanwo-custom-amount", "true");
        output.Attributes.SetAttribute("data-sanwo-button-text", ButtonText);
        output.Attributes.SetAttribute("data-sanwo-placeholder", Placeholder);
        ...
        if (MinAmount.HasValue)
            output.Attributes.SetAttribute("data-sanwo-min-amount", MinAmount.Value.ToString());
        if (MaxAmount.HasValue)
            output.Attributes.SetAttribute("data-sanwo-max-amount", MaxAmount.Value.ToString());
